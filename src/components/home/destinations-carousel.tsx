...
const recentDestinations: DestinationItem[] = [
  {
    id: "1",
...
export default function RecentDestinationsCarousel() {
  ...
  return (
    <section className="w-full  bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">Destinos</h2>
        ...
        >
          {recentDestinations.map((destination) => (
            <SwiperSlide key={destination.id} className="pb-10">
              <ProductCard
                id={destination.id}
