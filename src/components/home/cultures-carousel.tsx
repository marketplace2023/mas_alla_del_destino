...
const recentCultures: CultureItem[] = [
  {
    id: "1",
...
export default function RecentCulturesCarousel() {
  ...
  return (
    <section className="w-full  bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">Cultura</h2>
        ...
        >
          {recentCultures.map((culture) => (
            <SwiperSlide key={culture.id} className="pb-10">
              <ProductCard
                id={culture.id}
                image={culture.image}
                name={culture.name}
